...
namespace Company.LanguageLab03
{
	...
	/// </remarks>
	public partial class LanguageLab03HelpKeywordHelper : LanguageLab03HelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new LanguageLab03HelpKeywordHelper.
		/// </summary>
		protected LanguageLab03HelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the LanguageLab03HelpKeywordHelper.
		/// </summary>
		public static LanguageLab03HelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class LanguageLab03HelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new LanguageLab03HelpKeywordHelperBase.
		/// </summary>
		protected LanguageLab03HelpKeywordHelperBase()
			: base() { }
