...
namespace Company.LanguageLab03
{
	...
	public partial class ExampleModelSerializer : DslModeling::DomainClassXmlSerializer
	{
		...
		public override void Read(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				if (!reader.IsEmptyElement)
				{
					...
					LanguageLab03SerializationHelper.Instance.ReadExtensions(serializationContext, element, reader);
					...
					while (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
					{
						...
						if (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
						{
							...
							LanguageLab03SerializationBehaviorSerializationMessages.UnexpectedXmlElement(serializationContext, reader);
				...
				else
				{
					...
					if (newExampleModelHasElements != null)
					{
						...
						{	// The relationship should be serialized in short-form.
							LanguageLab03SerializationBehaviorSerializationMessages.ExpectingShortFormRelationship(serializationContext, reader, typeof(ExampleModelHasElements));
						}
		...
		protected override DslModeling::ModelElement CreateInstance(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::Partition partition)
		{
			...
			try
			{
				...
				{	// Create a default Id.
					...
					LanguageLab03SerializationBehaviorSerializationMessages.MissingId(serializationContext, reader, id);
				}
				else
				{
			...
			{	
				LanguageLab03SerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "Id", typeof(global::System.Guid), idStr);
			}
		...
		{
			string monikerString = LanguageLab03SerializationHelper.Instance.ReadAttribute(serializationContext, sourceRolePlayer, reader, this.MonikerAttributeName);
	
			if (string.IsNullOrEmpty(monikerString))
			{	
				LanguageLab03SerializationBehaviorSerializationMessages.MissingMoniker(serializationContext, reader, this.MonikerAttributeName);
				return null;
			}
			try
			{	// Normalize the Id.
			...
			{
				LanguageLab03SerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, this.MonikerAttributeName, typeof(global::System.Guid), monikerString);
				return null;
			}
		...
		public override void WriteMoniker(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer, DslModeling::ModelElement sourceRolePlayer, DslModeling::DomainRelationshipXmlSerializer relSerializer)
		{
			...
			LanguageLab03SerializationHelper.Instance.WriteAttributeString(serializationContext, element, writer, this.MonikerAttributeName, monikerString);
		...
		public override void Write(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer, DslModeling::RootElementSettings rootElementSettings)
		{
			...
			{
				LanguageLab03SerializationHelper.Instance.WriteExtensions(serializationContext, element, writer);
			}
...
namespace Company.LanguageLab03
{
	...
	public partial class ExampleElementSerializer : DslModeling::DomainClassXmlSerializer
	{
		...
		protected override void ReadPropertiesFromAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				string attribName = LanguageLab03SerializationHelper.Instance.ReadAttribute(serializationContext, element, reader, "name");
				if (attribName != null)
				{
					...
					{	// Invalid property value, ignored.
						LanguageLab03SerializationBehaviorSerializationMessages.IgnoredPropertyValue(serializationContext, reader, "name", typeof(global::System.String), attribName);
					}
				}
			}
		}
			...
			while (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				...
				else
				{
					...
					if (newExampleElementReferencesTargets != null)
					{
						...
						{	// The relationship should be serialized in short-form.
							LanguageLab03SerializationBehaviorSerializationMessages.ExpectingShortFormRelationship(serializationContext, reader, typeof(ExampleElementReferencesTargets));
						}
		...
		protected override void WritePropertiesAsAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				...
				if (!serializationContext.Result.Failed)
				{
					LanguageLab03SerializationHelper.Instance.WriteAttributeString(serializationContext, element, writer, "name", propValue);
				}
			}
		}
	...
	public partial class ExampleModelHasElementsSerializer : DslModeling::DomainRelationshipXmlSerializer
	{
		...
		public override void Read(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				...
				{
					LanguageLab03SerializationBehaviorSerializationMessages.DanglingRelationship(serializationContext, reader, "ExampleModelHasElements");
				}
			}
	...
	public partial class ExampleElementReferencesTargetsSerializer : DslModeling::DomainRelationshipXmlSerializer
	{
		...
		public override void Read(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				...
				{
					LanguageLab03SerializationBehaviorSerializationMessages.DanglingRelationship(serializationContext, reader, "ExampleElementReferencesTargets");
				}
			}
...
{
	/// <summary>
	/// Serializer LanguageLab03DiagramSerializer for DomainClass LanguageLab03Diagram.
	/// </summary>
	public partial class LanguageLab03DiagramSerializer : DslDiagrams::DiagramSerializer
	{
		#region Constructor
		/// <summary>
		/// LanguageLab03DiagramSerializer Constructor
		/// </summary>
		public LanguageLab03DiagramSerializer ()
			: base ()
		{
		}
		#endregion
		...
		#region Public Properties
		/// <summary>
		/// This is the XML tag name used to serialize an instance of LanguageLab03Diagram.
		/// </summary>
		public override string XmlTagName
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return @"languageLab03Diagram"; }
		}
	
		/// <summary>
		/// This is the XML tag name used to serialize a monikerized instance of LanguageLab03Diagram.
		/// </summary>
		public override string MonikerTagName
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return @"languageLab03DiagramMoniker"; }
		}
		
		/// <summary>
		/// This is the name of the XML attribute that stores the moniker of LanguageLab03Diagram in a serialized monikerized instance.
		/// </summary>
		public override string MonikerAttributeName
		{
			[global::System.Diagnostics.DebuggerStepThrough]
		...
		#region Read Methods
		/// <summary>
		/// Public Read() method that deserializes one LanguageLab03Diagram instance from XML.
		/// </summary>
		/// <remarks>
		/// When this method is called, caller guarantees that the passed-in XML reader is positioned at the open XML tag
		/// of the LanguageLab03Diagram element that is about to be deserialized. 
		/// The method needs to ensure that when it returns, the reader is positioned at the open XML tag of the next sibling element,
		/// or the close tag of the parent element (or EOF).
		/// </remarks>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">In-memory LanguageLab03Diagram instance that will get the deserialized data.</param>
		/// <param name="reader">XmlReader to read serialized data from.</param>
		public override void Read(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			#region Check Parameters
		...
		#region TryCreateInstance
		/// <summary>
		/// This method creates a correct instance of LanguageLab03Diagram based on the tag currently pointed by the reader. If the reader
		/// is positioned at a serialized LanguageLab03Diagram, a new LanguageLab03Diagram instance will be created in the given partition, otherwise 
		/// null is returned.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the next element being read. This method should
		...
		/// <param name="reader">XmlReader to read serialized data from.</param>
		/// <param name="partition">Partition in which new elements should be created.</param>	
		/// <returns>Created LanguageLab03Diagram instance, or null if the reader is not pointing to a serialized LanguageLab03Diagram instance.</returns>
		public override DslModeling::ModelElement TryCreateInstance(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::Partition partition)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert (serializationContext != null);
			...
			if (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				string localName = reader.LocalName;
				if (string.Compare (localName, this.XmlTagName, global::System.StringComparison.CurrentCulture) == 0)
				{	// New "LanguageLab03Diagram" instance.
					result = this.CreateInstance(serializationContext, reader, partition);
				}
				else
				{	// Check for derived classes of "LanguageLab03Diagram".
					if (this.derivedClasses == null)
						this.ConstructDerivedClassesLookupTable(serializationContext, partition.DomainDataDirectory);
					global::System.Diagnostics.Debug.Assert (this.derivedClasses != null);
					DslModeling::DomainClassInfo derivedClass = null;
					if (this.derivedClasses.TryGetValue (localName, out derivedClass) && derivedClass != null)
					{	// New derived class instance.
						LanguageLab03DiagramSerializer derivedSerializer = serializationContext.Directory.GetSerializer(derivedClass.Id) as LanguageLab03DiagramSerializer;
						global::System.Diagnostics.Debug.Assert(derivedSerializer != null, "Cannot find serializer for " + derivedClass.Name + "!");
						result = derivedSerializer.CreateInstance(serializationContext, reader, partition);
					}
				}
		...
		/// <summary>
		/// This method creates an instance of LanguageLab03Diagram based on the tag currently pointed by the reader. The reader is guaranteed (by the caller)
		/// to be pointed at a serialized instance of LanguageLab03Diagram.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the ModelRoot instance being read. This method should
		/// not move the reader; the reader should remain at the same position when this method returns.
		...
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="reader">XmlReader to read serialized data from.</param>
		/// <param name="partition">Partition in which new LanguageLab03Diagram instance should be created.</param>	
		/// <returns>Created LanguageLab03Diagram instance.</returns>
		protected override DslModeling::ModelElement CreateInstance(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::Partition partition)
		{
			string idStr = reader.GetAttribute ("Id");
			try
			{
				...
				return new LanguageLab03Diagram(partition, new DslModeling::PropertyAssignment(DslModeling::ElementFactory.IdPropertyAssignment, id));
			}
			catch (global::System.ArgumentNullException /* anEx */)
			{	
				LanguageLab03SerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "Id", typeof(global::System.Guid), idStr);
		...
		/// <summary>
		/// Stores a mapping from XmlTagName to DomainClassInfo that derives from LanguageLab03Diagram, created on demand.
		/// </summary>
		private global::System.Collections.Generic.Dictionary<string, DslModeling::DomainClassInfo> derivedClasses;
	
		/// <summary>
		/// Construct the apping from XmlTagName to DomainClassInfo that derives from LanguageLab03Diagram.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="domainDataDirectory">DomainDataDirectory to be used to discover all derived classes.</param>
		private void ConstructDerivedClassesLookupTable(DslModeling::SerializationContext serializationContext, DslModeling::DomainDataDirectory domainDataDirectory)
		{
			...
			DslModeling::DomainClassInfo thisClass = domainDataDirectory.GetDomainClass(LanguageLab03Diagram.DomainClassId);
			global::System.Diagnostics.Debug.Assert(thisClass != null, "Cannot find DomainClassInfo for ModelRoot!");
		...
		#region TryCreateMonikerInstance
		/// <summary>
		/// This method creates a Moniker of the correct derived (including LanguageLab03Diagram itself) instance of LanguageLab03Diagram based on the tag currently pointed by the reader.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the next element being read. This method should
		/// not move the reader; the reader should remain at the same position when this method returns.
		...
		public override DslModeling::Moniker TryCreateMonikerInstance (DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::ModelElement sourceRolePlayer, global::System.Guid relDomainClassId, DslModeling::Partition partition)
		{
			...
			if (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				string localName = reader.LocalName;
				if (string.Compare (localName, this.MonikerTagName, global::System.StringComparison.CurrentCulture) == 0)
				{	// New "LanguageLab03Diagram" moniker instance.
					result = this.CreateMonikerInstance(serializationContext, reader, sourceRolePlayer, relDomainClassId, partition);
				}
				else
				{	// Check for derived classes of "LanguageLab03Diagram".
		...
		/// <summary>
		/// This method creates a Moniker of LanguageLab03Diagram based on the tag currently pointed by the reader.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the next element being read. This method should
		/// not move the reader; the reader should remain at the same position when this method returns.
		...
		protected override DslModeling::Moniker CreateMonikerInstance (DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::ModelElement sourceRolePlayer, global::System.Guid relDomainClassId, DslModeling::Partition partition)
		{
			...
			{	// Normalize the Id.
				global::System.Guid id = new global::System.Guid(monikerString);
				monikerString = id.ToString("D", global::System.Globalization.CultureInfo.CurrentCulture);
				DslModeling::Moniker result = new DslModeling::Moniker(new DslModeling::MonikerKey(monikerString, relDomainClassId, LanguageLab03Diagram.DomainClassId, partition.Store), partition.Store);
				// Set location info if possible.
				result.Location = serializationContext.Location;
				global::System.Xml.IXmlLineInfo xmlLineInfo = reader as global::System.Xml.IXmlLineInfo;
				if (xmlLineInfo != null)
		...
		/// <summary>
		/// Stores a mapping from Moniker Xml tag name to DomainClassInfo that derives from LanguageLab03Diagram, created on demand.
		/// </summary>
		private global::System.Collections.Generic.Dictionary<string, DslModeling::DomainClassInfo> derivedClassMonikers;
	
		/// <summary>
		/// Construct the mapping from Moniker Xml tag name to DomainClassInfo that derives from LanguageLab03Diagram.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="domainDataDirectory">DomainDataDirectory to be used to discover all derived classes.</param>
		private void ConstructDerivedClassMonikersLookupTable(DslModeling::SerializationContext serializationContext, DslModeling::DomainDataDirectory domainDataDirectory)
		...
		#region Write Methods
		/// <summary>
		/// Public WriteMoniker() method that writes a monikerized LanguageLab03Diagram instance into XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">LanguageLab03Diagram instance to be monikerized.</param>
		/// <param name="writer">XmlWriter to write serialized data to.</param>
		/// <param name="sourceRolePlayer">Source element that references the LanguageLab03Diagram instance being monikerized.</param>
		/// <param name="relSerializer">Serializer that handles the relationship connecting the source element to the LanguageLab03Diagram instance being monikerized.</param>
		public override void WriteMoniker(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer, DslModeling::ModelElement sourceRolePlayer, DslModeling::DomainRelationshipXmlSerializer relSerializer)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert (serializationContext != null);
		...
		/// <summary>
		/// Public Write() method that serializes one LanguageLab03Diagram instance into XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">LanguageLab03Diagram instance to be serialized.</param>
		/// <param name="writer">XmlWriter to write serialized data to.</param>
		/// <param name="rootElementSettings">
		/// The root element settings if the passed in element is serialized as a root element in the XML. The root element contains additional
		/// information like schema target namespace, version, etc.
		...
		#region Moniker Support
		/// <summary>
		/// This method calculates a moniker to a given LanguageLab03Diagram instance.
		/// </summary>
		/// <param name="directory">Directory to look up serializer based on model element type.</param>
		/// <param name="element">LanguageLab03Diagram instance to calculate qualified name for.</param>
		/// <returns>A fully qualified string moniker to the LanguageLab03Diagram instance.</returns>
		public override string CalculateQualifiedName(DslModeling::DomainXmlSerializerDirectory directory, DslModeling::ModelElement element)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert (directory != null);
			...
			LanguageLab03Diagram instance = element as LanguageLab03Diagram;
			global::System.Diagnostics.Debug.Assert(instance != null, "Expecting an instance of LanguageLab03Diagram!");
		...
		/// </summary>
		/// <param name="directory">Directory to look up serializer based on model element type.</param>
		/// <param name="element">LanguageLab03Diagram instance to get moniker qualifier from.</param>
		/// <returns>
		/// Value of this element's moniker qualifier property, if it has one, or the value of the container's moniker qualifier property. Or empty string if this
		/// element is not monikerized using standard /qualifier/key mechanism.
		/// </returns>
...
{
	/// <summary>
	/// A DomainXmlSerializationBehavior implementation for defined behavior LanguageLab03SerializationBehavior.
	/// This is the abstract base of the double-derived implementation.
	/// </summary>
	[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Justification = "Generated code.")]		
	public abstract class LanguageLab03SerializationBehaviorBase : DslModeling::DomainXmlSerializationBehavior
	{
		///<summary>
		/// The xml namespace used by this domain model when serializing
		///</summary>
		public const string DomainModelXmlNamespace = @"http://schemas.microsoft.com/dsltools/LanguageLab03";
		...
		/// </summary>
		protected LanguageLab03SerializationBehaviorBase() : base() { }
		#endregion
		...
		public override global::System.Collections.ObjectModel.ReadOnlyCollection<DslModeling::DomainXmlSerializerDirectoryEntry> AllSerializers
		{
			get
			{
				if (LanguageLab03SerializationBehavior.serializerTypes == null)
				{
					...
					LanguageLab03SerializationBehavior.serializerTypes = new global::System.Collections.Generic.List<DslModeling::DomainXmlSerializerDirectoryEntry>(7 + customSerializerCount);
	
					#region Serializers defined in this model
					LanguageLab03SerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(ExampleModel.DomainClassId, typeof(ExampleModelSerializer)));
					LanguageLab03SerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(ExampleElement.DomainClassId, typeof(ExampleElementSerializer)));
					LanguageLab03SerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(ExampleModelHasElements.DomainClassId, typeof(ExampleModelHasElementsSerializer)));
					LanguageLab03SerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(ExampleElementReferencesTargets.DomainClassId, typeof(ExampleElementReferencesTargetsSerializer)));
					LanguageLab03SerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(ExampleShape.DomainClassId, typeof(ExampleShapeSerializer)));
					LanguageLab03SerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(ExampleConnector.DomainClassId, typeof(ExampleConnectorSerializer)));
					LanguageLab03SerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(LanguageLab03Diagram.DomainClassId, typeof(LanguageLab03DiagramSerializer)));
					#endregion
					
					// Custom ones
					if (customSerializerCount > 0)
					{
						LanguageLab03SerializationBehavior.serializerTypes.AddRange(customSerializerTypes);
					}
				}
				return LanguageLab03SerializationBehavior.serializerTypes.AsReadOnly();
			}
		}
		...
		public override global::System.Collections.ObjectModel.ReadOnlyCollection<DslModeling::DomainXmlSerializerNamespaceEntry> AllNamespaces
		{
			get
			{
				if (LanguageLab03SerializationBehavior.namespaceEntries == null)
				{
					LanguageLab03SerializationBehavior.namespaceEntries = new global::System.Collections.Generic.List<DslModeling::DomainXmlSerializerNamespaceEntry>();
					LanguageLab03SerializationBehavior.namespaceEntries.Add(new DslModeling::DomainXmlSerializerNamespaceEntry(DomainModelXmlNamespace, typeof(global::Company.LanguageLab03.LanguageLab03DomainModel)));
				}
				return LanguageLab03SerializationBehavior.namespaceEntries.AsReadOnly();
			}
		}
	...
	/// </summary>
	public sealed partial class LanguageLab03SerializationBehavior : LanguageLab03SerializationBehaviorBase
	{
		#region Singleton Instance
		/// <summary>
		/// Singleton instance.
		/// </summary>
		private static LanguageLab03SerializationBehavior instance;
	
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable (global::System.Diagnostics.DebuggerBrowsableState.Never)]	// Will trigger creation otherwise.
		public static LanguageLab03SerializationBehavior Instance
		{
			get
			{	// No need for synchronization. Most likely running in single-thread environment, and creating an extra instance
				// doesn't really hurt.
				if (LanguageLab03SerializationBehavior.instance == null)
					LanguageLab03SerializationBehavior.instance = new LanguageLab03SerializationBehavior ();
				return LanguageLab03SerializationBehavior.instance;
			}
		}
		...
		/// </summary>
		private LanguageLab03SerializationBehavior() : base() { }
		#endregion
	}
}
...
{
	/// <summary>
	/// Moniker resolver for serialization behavior LanguageLab03SerializationBehavior.
	/// </summary>
	public partial class LanguageLab03SerializationBehaviorMonikerResolver : LanguageLab03SerializationBehaviorMonikerResolverBase
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		public LanguageLab03SerializationBehaviorMonikerResolver(DslModeling::Store store, DslModeling::DomainXmlSerializerDirectory directory)
	...
	/// <summary>
	/// Base moniker resolver for serialization behavior LanguageLab03SerializationBehavior.
	/// </summary>
	public partial class LanguageLab03SerializationBehaviorMonikerResolverBase : DslModeling::SimpleMonikerResolver
	{
		#region Member Variables
		/// <summary>
		...
		/// <param name="store">Store for this moniker resolver.</param>
		/// <param name="directory">Directory to used by this resolver to look up for serializers.</param>
		public LanguageLab03SerializationBehaviorMonikerResolverBase(DslModeling::Store store, DslModeling::DomainXmlSerializerDirectory directory)
			: base (store)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(directory != null);
		...
		protected override void OnUnresolvedMoniker(DslModeling::SerializationResult serializationResult, DslModeling::Moniker moniker)
		{
			...
			{
				LanguageLab03SerializationBehaviorSerializationMessages.UnresolvedMoniker(serializationResult, moniker);
			}
		}
		...
		protected override void OnMonikerResolvedToDuplicateLink(DslModeling::SerializationResult serializationResult, DslModeling::Moniker moniker)
		{
			if (serializationResult != null)
			{
				LanguageLab03SerializationBehaviorSerializationMessages.MonikerResolvedToDuplicateLink(serializationResult, moniker);
			}
		...
		protected override void OnAmbiguousMoniker(DslModeling::SerializationContext context, string moniker, DslModeling::ModelElement element1, DslModeling::ModelElement element2)
		{
			if (context != null)
			{
				LanguageLab03SerializationBehaviorSerializationMessages.AmbiguousMoniker(context, moniker, element1, element2);
			}
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return LanguageLab03SerializationBehaviorSerializationMessages.ResourceManager.GetString("CannotOpenDocument"); }
		}
		#endregion
	}
}
...
namespace Company.LanguageLab03
{
	...
	/// </summary>
	public static partial class LanguageLab03SerializationBehaviorSerializationMessages
	{
		/// <summary>
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return LanguageLab03DomainModel.SingletonResourceManager; }
		}
...
namespace Company.LanguageLab03
{
	...
	/// that can be used to serialize / deserialize the LanguageLab03 domain model.
	/// </summary>
	/// <remarks>Double-derived class - the default implementation is in LanguageLab03DomainModelSerializerBase.
	...
	[DslModeling::DomainModelSerializer(typeof(global::Company.LanguageLab03.LanguageLab03DomainModel), global::Company.LanguageLab03.LanguageLab03SerializationBehavior.DomainModelXmlNamespace, "LanguageLab03")]
	public partial class LanguageLab03DomainModelSerializer : LanguageLab03DomainModelSerializerBase
	{
	}
	...
	/// </summary>
	public abstract partial class LanguageLab03DomainModelSerializerBase : DslModeling::IDomainModelSerializer
	{
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return global::Company.LanguageLab03.LanguageLab03SerializationBehavior.DomainModelXmlNamespace; }
		}
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return typeof(global::Company.LanguageLab03.LanguageLab03DomainModel); }
		}
			...
			DslModeling::ISerializerLocator serializerLocator)
		{
			...
			return LanguageLab03SerializationHelper.Instance.LoadModel(serializationResult, partition, fileName, null, null, serializerLocator);
		}
			...
			System.Text.Encoding encoding)
		{
			...
			global::Company.LanguageLab03.ExampleModel rootElement = modelRoot as global::Company.LanguageLab03.ExampleModel;
			if (rootElement == null)
			{
				string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
					global::Company.LanguageLab03.LanguageLab03DomainModel.SingletonResourceManager.GetString("InvalidSaveRootElementType"),
			...
			LanguageLab03SerializationHelper.Instance.SaveModel(serializationResult, rootElement, fileName,encoding, true);
		}
		...
		/// <param name="diagramPartition">Partition in which the new LanguageLab03Diagram instance will be created.</param>
		/// <param name="diagramFileName">Name of the file from which the LanguageLab03Diagram instance will be deserialized.</param>
		/// <param name="serializerLocator">Used to locate any additional domain model types required to load the model. Can be null.</param>
		/// <returns>The loaded ExampleModel instance.</returns>
			...
			DslModeling::ISerializerLocator serializerLocator)
		{
			...
			return LanguageLab03SerializationHelper.Instance.LoadModelAndDiagram(serializationResult, modelPartition, modelFileName, diagramPartition, diagramFileName, null, null, serializerLocator);
		}
	
		/// <summary>
		/// Saves the given ExampleModel and LanguageLab03Diagram to the given files, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="modelRoot">ExampleModel instance to be saved.</param>
		/// <param name="modelFileName">Name of the file in which the CanonicalSampleRoot instance will be saved.</param>
		/// <param name="diagram">LanguageLab03Diagram to be saved.</param>
			...
			System.Text.Encoding encoding)
		{
			...
			global::Company.LanguageLab03.ExampleModel typedRoot = modelRoot as global::Company.LanguageLab03.ExampleModel;
			if (typedRoot == null)
			{
				string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
					global::Company.LanguageLab03.LanguageLab03DomainModel.SingletonResourceManager.GetString("InvalidSaveRootElementType"),
			...
			global::Company.LanguageLab03.LanguageLab03Diagram typedDiagram = diagram as global::Company.LanguageLab03.LanguageLab03Diagram;
			if (typedDiagram == null)
			{
				string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
					global::Company.LanguageLab03.LanguageLab03DomainModel.SingletonResourceManager.GetString("InvalidSaveDiagramType"),
					diagram.GetType().ToString());
	
				throw new global::System.ArgumentException(errorMessage, "diagram");
			}
	
			LanguageLab03SerializationHelper.Instance.SaveModelAndDiagram(serializationResult, typedRoot, modelFileName, typedDiagram, diagramFileName, encoding, true);
		}
