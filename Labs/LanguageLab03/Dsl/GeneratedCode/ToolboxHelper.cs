...
namespace Company.LanguageLab03
{
	...
	/// </remarks>
	public partial class LanguageLab03ToolboxHelper : LanguageLab03ToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new LanguageLab03ToolboxHelper.
		/// </summary>
		public LanguageLab03ToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class LanguageLab03ToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify LanguageLab03 toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "LanguageLab03.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new LanguageLab03ToolboxHelperBase.
		/// </summary>
		protected LanguageLab03ToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.LanguageLab03.LanguageLab03DomainModel.SingletonResourceManager.GetString("LanguageLab03ToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "Company.LanguageLab03.ExampleElementToolboxItem":
					// Add ExampleElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.LanguageLab03.ExampleElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Company.LanguageLab03.LanguageLab03ToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("LanguageLab03ToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Company.LanguageLab03.ExampleElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.LanguageLab03.ExampleRelationshipToolboxItem":

					// Add ExampleRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.LanguageLab03.ExampleRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.LanguageLab03.LanguageLab03DomainModel));
