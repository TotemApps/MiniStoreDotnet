...
namespace Company.LanguageLab03
{
	...
	/// </summary>
	internal partial class LanguageLab03CommandSet : LanguageLab03CommandSetBase
	{
		/// <summary>
		/// Constructs a new LanguageLab03CommandSet.
		/// </summary>
		public LanguageLab03CommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class LanguageLab03CommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new LanguageLab03CommandSetBase.
		/// </summary>
		protected LanguageLab03CommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewLanguageLab03ExplorerCommand,
				typeof(LanguageLab03EditorFactory).GUID);
		...
		{
			LanguageLab03ExplorerToolWindow explorer = this.LanguageLab03ExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected LanguageLab03DocData CurrentLanguageLab03DocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as LanguageLab03DocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected LanguageLab03DocView CurrentLanguageLab03DocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as LanguageLab03DocView;
			}
		}
		...
		/// </summary>
		protected LanguageLab03ExplorerToolWindow LanguageLab03ExplorerToolWindow
		{
			get
			{
				LanguageLab03ExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(LanguageLab03ExplorerToolWindow), true) as LanguageLab03ExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				LanguageLab03ExplorerToolWindow explorerWindow = this.LanguageLab03ExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class LanguageLab03ClipboardCommandSet : LanguageLab03ClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new LanguageLab03ClipboardCommandSet.
		/// </summary>
		public LanguageLab03ClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class LanguageLab03ClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new LanguageLab03ClipboardCommandSetBase.
		/// </summary>
		protected LanguageLab03ClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
