...
namespace Company.LanguageLab03
{
	...
	/// </summary>
	internal partial class LanguageLab03DocView : LanguageLab03DocViewBase
	{
		/// <summary>
		/// Constructs a new LanguageLab03DocView.
		/// </summary>
		public LanguageLab03DocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class LanguageLab03DocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new LanguageLab03DocView.
		/// </summary>
		protected LanguageLab03DocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			LanguageLab03DocDataBase docData = this.DocData as LanguageLab03DocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for LanguageLab03DocViewBase should be an LanguageLab03DocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.LanguageLab03.LanguageLab03Diagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.LanguageLab03.LanguageLab03Diagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.LanguageLab03.LanguageLab03ToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.LanguageLab03.LanguageLab03ToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.LanguageLab03DiagramMenu;
			}
		}
			...
			if(global::Company.LanguageLab03.LanguageLab03HelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.LanguageLab03.LanguageLab03HelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
