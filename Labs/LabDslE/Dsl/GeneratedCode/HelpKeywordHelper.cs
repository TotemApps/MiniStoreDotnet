...
namespace Company.LabDslE
{
	...
	/// </remarks>
	public partial class LabDslEHelpKeywordHelper : LabDslEHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new LabDslEHelpKeywordHelper.
		/// </summary>
		protected LabDslEHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the LabDslEHelpKeywordHelper.
		/// </summary>
		public static LabDslEHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class LabDslEHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new LabDslEHelpKeywordHelperBase.
		/// </summary>
		protected LabDslEHelpKeywordHelperBase()
			: base() { }
