...
namespace Company.LabDslE
{
	...
	/// </remarks>
	public partial class LabDslEToolboxHelper : LabDslEToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new LabDslEToolboxHelper.
		/// </summary>
		public LabDslEToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class LabDslEToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify LabDslE toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "LabDslE.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new LabDslEToolboxHelperBase.
		/// </summary>
		protected LabDslEToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.LabDslE.LabDslEDomainModel.SingletonResourceManager.GetString("LabDslEToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.LabDslE.LabDslEDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.LabDslE.FeatureElementToolboxItem":
					// Add FeatureElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.LabDslE.FeatureElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::Company.LabDslE.FeatureElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.LabDslE.OptionalRelationshipToolboxItem":

					// Add OptionalRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.LabDslE.OptionalRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.LabDslE.LabDslEDomainModel));
