...
namespace Company.LabDslE
{
	...
	[VSShell::ProvideToolWindow(typeof(LabDslEExplorerToolWindow), MultiInstances = false, Style = VSShell::VsDockStyle.Tabbed, Orientation = VSShell::ToolWindowOrientation.Right, Window = "{3AE79031-E1BC-11D0-8F78-00A0C9110057}")]
	...
	[DslShell::ProvideXmlEditorChooserBlockSxSWithXmlEditor(@"LabDslE", typeof(LabDslEEditorFactory))]

	internal abstract partial class LabDslEPackageBase : DslShell::ModelingPackage
	{
		protected global::Company.LabDslE.LabDslEToolboxHelper toolboxHelper;	
		...
		protected override void Initialize()
		{
			...
			this.RegisterEditorFactory(new LabDslEEditorFactory(this));
			
			// Initialize the toolbox helper
			toolboxHelper = new global::Company.LabDslE.LabDslEToolboxHelper(this);

			// Create the command set that handles menu commands provided by this package.
			LabDslECommandSet commandSet = new LabDslECommandSet(this);
			commandSet.Initialize();
			
			// Create the command set that handles cut/copy/paste commands provided by this package.
			LabDslEClipboardCommandSet clipboardCommandSet = new LabDslEClipboardCommandSet(this);
			clipboardCommandSet.Initialize();
			
			// Register the model explorer tool window for this DSL.
			this.AddToolWindow(typeof(LabDslEExplorerToolWindow));
...
namespace Company.LabDslE
{
	...
	[global::Microsoft.VisualStudio.TextTemplating.VSHost.ProvideDirectiveProcessor(typeof(global::Company.LabDslE.LabDslEDirectiveProcessor), global::Company.LabDslE.LabDslEDirectiveProcessor.LabDslEDirectiveProcessorName, "A directive processor that provides access to LabDslE files")]
	[global::System.Runtime.InteropServices.Guid(Constants.LabDslEPackageId)]
	internal sealed partial class LabDslEPackage : LabDslEPackageBase
	{
	}
}