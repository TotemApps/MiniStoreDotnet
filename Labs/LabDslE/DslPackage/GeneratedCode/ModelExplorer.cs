...
namespace Company.LabDslE
{
	...
	/// </summary>
	internal partial class LabDslEExplorer : LabDslEExplorerBase
	{
		/// <summary>
		/// Constructs a new LabDslEExplorer.
		/// </summary>
		public LabDslEExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the LabDslEExplorerToolWindow.
	/// </summary>
	internal abstract class LabDslEExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new LabDslEExplorerBase.
		/// </summary>
		protected LabDslEExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.LabDslEExplorerMenu;
			}
		}
