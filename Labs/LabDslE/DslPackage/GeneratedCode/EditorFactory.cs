...
namespace Company.LabDslE
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.LabDslEEditorFactoryId)]
	internal partial class LabDslEEditorFactory : LabDslEEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new LabDslEEditorFactory.
		/// </summary>
		public LabDslEEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class LabDslEEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected LabDslEEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new LabDslEDocData(this.ServiceProvider, typeof(LabDslEEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new LabDslEDocView(docData, this.ServiceProvider);
		}
	}
}
