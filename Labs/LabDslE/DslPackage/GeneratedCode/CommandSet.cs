...
namespace Company.LabDslE
{
	...
	/// </summary>
	internal partial class LabDslECommandSet : LabDslECommandSetBase
	{
		/// <summary>
		/// Constructs a new LabDslECommandSet.
		/// </summary>
		public LabDslECommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class LabDslECommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new LabDslECommandSetBase.
		/// </summary>
		protected LabDslECommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewLabDslEExplorerCommand,
				typeof(LabDslEEditorFactory).GUID);
		...
		{
			LabDslEExplorerToolWindow explorer = this.LabDslEExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected LabDslEDocData CurrentLabDslEDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as LabDslEDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected LabDslEDocView CurrentLabDslEDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as LabDslEDocView;
			}
		}
		...
		/// </summary>
		protected LabDslEExplorerToolWindow LabDslEExplorerToolWindow
		{
			get
			{
				LabDslEExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(LabDslEExplorerToolWindow), true) as LabDslEExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				LabDslEExplorerToolWindow explorerWindow = this.LabDslEExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class LabDslEClipboardCommandSet : LabDslEClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new LabDslEClipboardCommandSet.
		/// </summary>
		public LabDslEClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class LabDslEClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new LabDslEClipboardCommandSetBase.
		/// </summary>
		protected LabDslEClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
