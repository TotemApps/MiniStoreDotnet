...
namespace Company.LabDslE
{
	...
	/// </summary>
	internal partial class LabDslEDocView : LabDslEDocViewBase
	{
		/// <summary>
		/// Constructs a new LabDslEDocView.
		/// </summary>
		public LabDslEDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class LabDslEDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new LabDslEDocView.
		/// </summary>
		protected LabDslEDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			LabDslEDocDataBase docData = this.DocData as LabDslEDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for LabDslEDocViewBase should be an LabDslEDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.LabDslE.LabDslEDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.LabDslE.LabDslEDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.LabDslE.LabDslEToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.LabDslE.LabDslEToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.LabDslEDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.LabDslE.LabDslEHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.LabDslE.LabDslEHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.LabDslE.LabDslEHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
