...
namespace Company.FeatureModelLab02
{
	...
	/// </remarks>
	public partial class FeatureModelLab02HelpKeywordHelper : FeatureModelLab02HelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new FeatureModelLab02HelpKeywordHelper.
		/// </summary>
		protected FeatureModelLab02HelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the FeatureModelLab02HelpKeywordHelper.
		/// </summary>
		public static FeatureModelLab02HelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class FeatureModelLab02HelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new FeatureModelLab02HelpKeywordHelperBase.
		/// </summary>
		protected FeatureModelLab02HelpKeywordHelperBase()
			: base() { }
