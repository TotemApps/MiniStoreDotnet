...
namespace Company.FeatureModelLab02
{
	...
	/// </remarks>
	public partial class FeatureModelLab02ToolboxHelper : FeatureModelLab02ToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new FeatureModelLab02ToolboxHelper.
		/// </summary>
		public FeatureModelLab02ToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class FeatureModelLab02ToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify FeatureModelLab02 toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "FeatureModelLab02.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new FeatureModelLab02ToolboxHelperBase.
		/// </summary>
		protected FeatureModelLab02ToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.FeatureModelLab02.FeatureModelLab02DomainModel.SingletonResourceManager.GetString("FeatureModelLab02ToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.FeatureModelLab02.FeatureModelLab02DomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.FeatureModelLab02.FeatureElementToolboxItem":
					// Add FeatureElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.FeatureModelLab02.FeatureElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Company.FeatureModelLab02.FeatureModelLab02ToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("FeatureModelLab02ToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Company.FeatureModelLab02.FeatureElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.FeatureModelLab02.OptionalRelationshipToolboxItem":

					// Add OptionalRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.FeatureModelLab02.OptionalRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.FeatureModelLab02.FeatureModelLab02DomainModel));
