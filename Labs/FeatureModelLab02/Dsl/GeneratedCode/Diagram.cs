...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "Company.FeatureModelLab02.FeatureModelLab02Diagram")]

namespace Company.FeatureModelLab02
{
	/// <summary>
	/// DomainClass FeatureModelLab02Diagram
	/// Description for Company.FeatureModelLab02.FeatureModelLab02Diagram
	/// </summary>
	[DslDesign::DisplayNameResource("Company.FeatureModelLab02.FeatureModelLab02Diagram.DisplayName", typeof(global::Company.FeatureModelLab02.FeatureModelLab02DomainModel), "Company.FeatureModelLab02.GeneratedCode.DomainModelResx")]
	[DslDesign::DescriptionResource("Company.FeatureModelLab02.FeatureModelLab02Diagram.Description", typeof(global::Company.FeatureModelLab02.FeatureModelLab02DomainModel), "Company.FeatureModelLab02.GeneratedCode.DomainModelResx")]
	[DslModeling::DomainModelOwner(typeof(global::Company.FeatureModelLab02.FeatureModelLab02DomainModel))]
	[global::System.CLSCompliant(true)]
	[DslModeling::DomainObjectId("09b1e20f-991a-4eaa-a13c-1d8453cd0bcb")]
	public partial class FeatureModelLab02Diagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::Company.FeatureModelLab02.FeatureModelLab02ToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		protected override DslDiagrams::ShapeElement CreateChildShape(DslModeling::ModelElement element)
		{
			...
			if(element is global::Company.FeatureModelLab02.FeatureElementReferencesTargets)
			{
				global::Company.FeatureModelLab02.ExampleConnector newShape = new global::Company.FeatureModelLab02.ExampleConnector(this.Partition);
				return newShape;
			}
		...
		private global::Company.FeatureModelLab02.OptionalRelationshipConnectAction optionalRelationshipConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::Company.FeatureModelLab02.FeatureModelLab02ToolboxHelper.OptionalRelationshipFilterString))
				{
					if (this.optionalRelationshipConnectAction == null)
					{
						this.optionalRelationshipConnectAction = new global::Company.FeatureModelLab02.OptionalRelationshipConnectAction(this);
		...
		/// <summary>
		/// FeatureModelLab02Diagram domain class Id.
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0x09b1e20f, 0x991a, 0x4eaa, 0xa1, 0x3c, 0x1d, 0x84, 0x53, 0xcd, 0x0b, 0xcb);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public FeatureModelLab02Diagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public FeatureModelLab02Diagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace Company.FeatureModelLab02
{
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::Company.FeatureModelLab02.FeatureElement), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::Company.FeatureModelLab02.FeatureElementReferencesTargets), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				if(childElement is global::Company.FeatureModelLab02.FeatureElement)
				{
					parentElement = GetParentForFeatureElement((global::Company.FeatureModelLab02.FeatureElement)childElement);
				} else
				{
					parentElement = null;
				}
			...
			public static global::Company.FeatureModelLab02.FeatureModel GetParentForFeatureElement( global::Company.FeatureModelLab02.FeatureElement root )
			{
				// Segments 0 and 1
				global::Company.FeatureModelLab02.FeatureModel result = root.FeatureModel;
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::Company.FeatureModelLab02.FeatureModelLab02Diagram diagram = linkShape.Diagram as global::Company.FeatureModelLab02.FeatureModelLab02Diagram;
						if (diagram != null)
						{
