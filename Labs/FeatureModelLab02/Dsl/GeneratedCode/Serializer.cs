...
namespace Company.FeatureModelLab02
{
	...
	public partial class FeatureModelSerializer : DslModeling::DomainClassXmlSerializer
	{
		...
		public override void Read(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				if (!reader.IsEmptyElement)
				{
					...
					FeatureModelLab02SerializationHelper.Instance.ReadExtensions(serializationContext, element, reader);
					...
					while (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
					{
						...
						if (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
						{
							...
							FeatureModelLab02SerializationBehaviorSerializationMessages.UnexpectedXmlElement(serializationContext, reader);
				...
				else
				{
					...
					if (newFeatureModelHasElements != null)
					{
						...
						{	// The relationship should be serialized in short-form.
							FeatureModelLab02SerializationBehaviorSerializationMessages.ExpectingShortFormRelationship(serializationContext, reader, typeof(FeatureModelHasElements));
						}
		...
		protected override DslModeling::ModelElement CreateInstance(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::Partition partition)
		{
			...
			try
			{
				...
				{	// Create a default Id.
					...
					FeatureModelLab02SerializationBehaviorSerializationMessages.MissingId(serializationContext, reader, id);
				}
				else
				{
			...
			{	
				FeatureModelLab02SerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "Id", typeof(global::System.Guid), idStr);
			}
		...
		{
			string monikerString = FeatureModelLab02SerializationHelper.Instance.ReadAttribute(serializationContext, sourceRolePlayer, reader, this.MonikerAttributeName);
	
			if (string.IsNullOrEmpty(monikerString))
			{	
				FeatureModelLab02SerializationBehaviorSerializationMessages.MissingMoniker(serializationContext, reader, this.MonikerAttributeName);
				return null;
			}
			try
			{	// Normalize the Id.
			...
			{
				FeatureModelLab02SerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, this.MonikerAttributeName, typeof(global::System.Guid), monikerString);
				return null;
			}
		...
		public override void WriteMoniker(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer, DslModeling::ModelElement sourceRolePlayer, DslModeling::DomainRelationshipXmlSerializer relSerializer)
		{
			...
			FeatureModelLab02SerializationHelper.Instance.WriteAttributeString(serializationContext, element, writer, this.MonikerAttributeName, monikerString);
		...
		public override void Write(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer, DslModeling::RootElementSettings rootElementSettings)
		{
			...
			{
				FeatureModelLab02SerializationHelper.Instance.WriteExtensions(serializationContext, element, writer);
			}
...
namespace Company.FeatureModelLab02
{
	...
	public partial class FeatureElementSerializer : DslModeling::DomainClassXmlSerializer
	{
		...
		protected override void ReadPropertiesFromAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				string attribName = FeatureModelLab02SerializationHelper.Instance.ReadAttribute(serializationContext, element, reader, "name");
				if (attribName != null)
				{
					...
					{	// Invalid property value, ignored.
						FeatureModelLab02SerializationBehaviorSerializationMessages.IgnoredPropertyValue(serializationContext, reader, "name", typeof(global::System.String), attribName);
					}
				}
			}
		}
			...
			while (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				...
				else
				{
					...
					if (newFeatureElementReferencesTargets != null)
					{
						...
						{	// The relationship should be serialized in short-form.
							FeatureModelLab02SerializationBehaviorSerializationMessages.ExpectingShortFormRelationship(serializationContext, reader, typeof(FeatureElementReferencesTargets));
						}
	...
	public partial class FeatureModelHasElementsSerializer : DslModeling::DomainRelationshipXmlSerializer
	{
		...
		public override void Read(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				...
				{
					FeatureModelLab02SerializationBehaviorSerializationMessages.DanglingRelationship(serializationContext, reader, "FeatureModelHasElements");
				}
			}
	...
	public partial class FeatureElementReferencesTargetsSerializer : DslModeling::DomainRelationshipXmlSerializer
	{
		...
		public override void Read(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				...
				{
					FeatureModelLab02SerializationBehaviorSerializationMessages.DanglingRelationship(serializationContext, reader, "FeatureElementReferencesTargets");
				}
			}
...
{
	/// <summary>
	/// Serializer FeatureModelLab02DiagramSerializer for DomainClass FeatureModelLab02Diagram.
	/// </summary>
	public partial class FeatureModelLab02DiagramSerializer : DslDiagrams::DiagramSerializer
	{
		#region Constructor
		/// <summary>
		/// FeatureModelLab02DiagramSerializer Constructor
		/// </summary>
		public FeatureModelLab02DiagramSerializer ()
			: base ()
		{
		}
		#endregion
		...
		#region Public Properties
		/// <summary>
		/// This is the XML tag name used to serialize an instance of FeatureModelLab02Diagram.
		/// </summary>
		public override string XmlTagName
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return @"featureModelLab02Diagram"; }
		}
	
		/// <summary>
		/// This is the XML tag name used to serialize a monikerized instance of FeatureModelLab02Diagram.
		/// </summary>
		public override string MonikerTagName
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return @"featureModelLab02DiagramMoniker"; }
		}
		
		/// <summary>
		/// This is the name of the XML attribute that stores the moniker of FeatureModelLab02Diagram in a serialized monikerized instance.
		/// </summary>
		public override string MonikerAttributeName
		{
			[global::System.Diagnostics.DebuggerStepThrough]
		...
		#region Read Methods
		/// <summary>
		/// Public Read() method that deserializes one FeatureModelLab02Diagram instance from XML.
		/// </summary>
		/// <remarks>
		/// When this method is called, caller guarantees that the passed-in XML reader is positioned at the open XML tag
		/// of the FeatureModelLab02Diagram element that is about to be deserialized. 
		/// The method needs to ensure that when it returns, the reader is positioned at the open XML tag of the next sibling element,
		/// or the close tag of the parent element (or EOF).
		/// </remarks>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">In-memory FeatureModelLab02Diagram instance that will get the deserialized data.</param>
		/// <param name="reader">XmlReader to read serialized data from.</param>
		public override void Read(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			#region Check Parameters
		...
		#region TryCreateInstance
		/// <summary>
		/// This method creates a correct instance of FeatureModelLab02Diagram based on the tag currently pointed by the reader. If the reader
		/// is positioned at a serialized FeatureModelLab02Diagram, a new FeatureModelLab02Diagram instance will be created in the given partition, otherwise 
		/// null is returned.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the next element being read. This method should
		...
		/// <param name="reader">XmlReader to read serialized data from.</param>
		/// <param name="partition">Partition in which new elements should be created.</param>	
		/// <returns>Created FeatureModelLab02Diagram instance, or null if the reader is not pointing to a serialized FeatureModelLab02Diagram instance.</returns>
		public override DslModeling::ModelElement TryCreateInstance(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::Partition partition)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert (serializationContext != null);
			...
			if (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				string localName = reader.LocalName;
				if (string.Compare (localName, this.XmlTagName, global::System.StringComparison.CurrentCulture) == 0)
				{	// New "FeatureModelLab02Diagram" instance.
					result = this.CreateInstance(serializationContext, reader, partition);
				}
				else
				{	// Check for derived classes of "FeatureModelLab02Diagram".
					if (this.derivedClasses == null)
						this.ConstructDerivedClassesLookupTable(serializationContext, partition.DomainDataDirectory);
					global::System.Diagnostics.Debug.Assert (this.derivedClasses != null);
					DslModeling::DomainClassInfo derivedClass = null;
					if (this.derivedClasses.TryGetValue (localName, out derivedClass) && derivedClass != null)
					{	// New derived class instance.
						FeatureModelLab02DiagramSerializer derivedSerializer = serializationContext.Directory.GetSerializer(derivedClass.Id) as FeatureModelLab02DiagramSerializer;
						global::System.Diagnostics.Debug.Assert(derivedSerializer != null, "Cannot find serializer for " + derivedClass.Name + "!");
						result = derivedSerializer.CreateInstance(serializationContext, reader, partition);
					}
				}
		...
		/// <summary>
		/// This method creates an instance of FeatureModelLab02Diagram based on the tag currently pointed by the reader. The reader is guaranteed (by the caller)
		/// to be pointed at a serialized instance of FeatureModelLab02Diagram.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the ModelRoot instance being read. This method should
		/// not move the reader; the reader should remain at the same position when this method returns.
		...
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="reader">XmlReader to read serialized data from.</param>
		/// <param name="partition">Partition in which new FeatureModelLab02Diagram instance should be created.</param>	
		/// <returns>Created FeatureModelLab02Diagram instance.</returns>
		protected override DslModeling::ModelElement CreateInstance(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::Partition partition)
		{
			string idStr = reader.GetAttribute ("Id");
			try
			{
				...
				return new FeatureModelLab02Diagram(partition, new DslModeling::PropertyAssignment(DslModeling::ElementFactory.IdPropertyAssignment, id));
			}
			catch (global::System.ArgumentNullException /* anEx */)
			{	
				FeatureModelLab02SerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "Id", typeof(global::System.Guid), idStr);
		...
		/// <summary>
		/// Stores a mapping from XmlTagName to DomainClassInfo that derives from FeatureModelLab02Diagram, created on demand.
		/// </summary>
		private global::System.Collections.Generic.Dictionary<string, DslModeling::DomainClassInfo> derivedClasses;
	
		/// <summary>
		/// Construct the apping from XmlTagName to DomainClassInfo that derives from FeatureModelLab02Diagram.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="domainDataDirectory">DomainDataDirectory to be used to discover all derived classes.</param>
		private void ConstructDerivedClassesLookupTable(DslModeling::SerializationContext serializationContext, DslModeling::DomainDataDirectory domainDataDirectory)
		{
			...
			DslModeling::DomainClassInfo thisClass = domainDataDirectory.GetDomainClass(FeatureModelLab02Diagram.DomainClassId);
			global::System.Diagnostics.Debug.Assert(thisClass != null, "Cannot find DomainClassInfo for ModelRoot!");
		...
		#region TryCreateMonikerInstance
		/// <summary>
		/// This method creates a Moniker of the correct derived (including FeatureModelLab02Diagram itself) instance of FeatureModelLab02Diagram based on the tag currently pointed by the reader.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the next element being read. This method should
		/// not move the reader; the reader should remain at the same position when this method returns.
		...
		public override DslModeling::Moniker TryCreateMonikerInstance (DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::ModelElement sourceRolePlayer, global::System.Guid relDomainClassId, DslModeling::Partition partition)
		{
			...
			if (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
			{
				string localName = reader.LocalName;
				if (string.Compare (localName, this.MonikerTagName, global::System.StringComparison.CurrentCulture) == 0)
				{	// New "FeatureModelLab02Diagram" moniker instance.
					result = this.CreateMonikerInstance(serializationContext, reader, sourceRolePlayer, relDomainClassId, partition);
				}
				else
				{	// Check for derived classes of "FeatureModelLab02Diagram".
		...
		/// <summary>
		/// This method creates a Moniker of FeatureModelLab02Diagram based on the tag currently pointed by the reader.
		/// </summary>
		/// <remarks>
		/// The caller will guarantee that the reader is positioned at open XML tag of the next element being read. This method should
		/// not move the reader; the reader should remain at the same position when this method returns.
		...
		protected override DslModeling::Moniker CreateMonikerInstance (DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::ModelElement sourceRolePlayer, global::System.Guid relDomainClassId, DslModeling::Partition partition)
		{
			...
			{	// Normalize the Id.
				global::System.Guid id = new global::System.Guid(monikerString);
				monikerString = id.ToString("D", global::System.Globalization.CultureInfo.CurrentCulture);
				DslModeling::Moniker result = new DslModeling::Moniker(new DslModeling::MonikerKey(monikerString, relDomainClassId, FeatureModelLab02Diagram.DomainClassId, partition.Store), partition.Store);
				// Set location info if possible.
				result.Location = serializationContext.Location;
				global::System.Xml.IXmlLineInfo xmlLineInfo = reader as global::System.Xml.IXmlLineInfo;
				if (xmlLineInfo != null)
		...
		/// <summary>
		/// Stores a mapping from Moniker Xml tag name to DomainClassInfo that derives from FeatureModelLab02Diagram, created on demand.
		/// </summary>
		private global::System.Collections.Generic.Dictionary<string, DslModeling::DomainClassInfo> derivedClassMonikers;
	
		/// <summary>
		/// Construct the mapping from Moniker Xml tag name to DomainClassInfo that derives from FeatureModelLab02Diagram.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="domainDataDirectory">DomainDataDirectory to be used to discover all derived classes.</param>
		private void ConstructDerivedClassMonikersLookupTable(DslModeling::SerializationContext serializationContext, DslModeling::DomainDataDirectory domainDataDirectory)
		...
		#region Write Methods
		/// <summary>
		/// Public WriteMoniker() method that writes a monikerized FeatureModelLab02Diagram instance into XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">FeatureModelLab02Diagram instance to be monikerized.</param>
		/// <param name="writer">XmlWriter to write serialized data to.</param>
		/// <param name="sourceRolePlayer">Source element that references the FeatureModelLab02Diagram instance being monikerized.</param>
		/// <param name="relSerializer">Serializer that handles the relationship connecting the source element to the FeatureModelLab02Diagram instance being monikerized.</param>
		public override void WriteMoniker(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer, DslModeling::ModelElement sourceRolePlayer, DslModeling::DomainRelationshipXmlSerializer relSerializer)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert (serializationContext != null);
		...
		/// <summary>
		/// Public Write() method that serializes one FeatureModelLab02Diagram instance into XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">FeatureModelLab02Diagram instance to be serialized.</param>
		/// <param name="writer">XmlWriter to write serialized data to.</param>
		/// <param name="rootElementSettings">
		/// The root element settings if the passed in element is serialized as a root element in the XML. The root element contains additional
		/// information like schema target namespace, version, etc.
		...
		#region Moniker Support
		/// <summary>
		/// This method calculates a moniker to a given FeatureModelLab02Diagram instance.
		/// </summary>
		/// <param name="directory">Directory to look up serializer based on model element type.</param>
		/// <param name="element">FeatureModelLab02Diagram instance to calculate qualified name for.</param>
		/// <returns>A fully qualified string moniker to the FeatureModelLab02Diagram instance.</returns>
		public override string CalculateQualifiedName(DslModeling::DomainXmlSerializerDirectory directory, DslModeling::ModelElement element)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert (directory != null);
			...
			FeatureModelLab02Diagram instance = element as FeatureModelLab02Diagram;
			global::System.Diagnostics.Debug.Assert(instance != null, "Expecting an instance of FeatureModelLab02Diagram!");
		...
		/// </summary>
		/// <param name="directory">Directory to look up serializer based on model element type.</param>
		/// <param name="element">FeatureModelLab02Diagram instance to get moniker qualifier from.</param>
		/// <returns>
		/// Value of this element's moniker qualifier property, if it has one, or the value of the container's moniker qualifier property. Or empty string if this
		/// element is not monikerized using standard /qualifier/key mechanism.
		/// </returns>
...
{
	/// <summary>
	/// A DomainXmlSerializationBehavior implementation for defined behavior FeatureModelLab02SerializationBehavior.
	/// This is the abstract base of the double-derived implementation.
	/// </summary>
	[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Justification = "Generated code.")]		
	public abstract class FeatureModelLab02SerializationBehaviorBase : DslModeling::DomainXmlSerializationBehavior
	{
		///<summary>
		/// The xml namespace used by this domain model when serializing
		///</summary>
		public const string DomainModelXmlNamespace = @"http://schemas.microsoft.com/dsltools/FeatureModelLab02";
		...
		/// </summary>
		protected FeatureModelLab02SerializationBehaviorBase() : base() { }
		#endregion
		...
		public override global::System.Collections.ObjectModel.ReadOnlyCollection<DslModeling::DomainXmlSerializerDirectoryEntry> AllSerializers
		{
			get
			{
				if (FeatureModelLab02SerializationBehavior.serializerTypes == null)
				{
					...
					FeatureModelLab02SerializationBehavior.serializerTypes = new global::System.Collections.Generic.List<DslModeling::DomainXmlSerializerDirectoryEntry>(7 + customSerializerCount);
	
					#region Serializers defined in this model
					FeatureModelLab02SerializationBehavior.serializerTypes.Add(new DslModeling::DomainXmlSerializerDirectoryEntry(FeatureModel.DomainClassId, typeof(FeatureModelSerializer)));
					...
					{
						FeatureModelLab02SerializationBehavior.serializerTypes.AddRange(customSerializerTypes);
					}
				}
				return FeatureModelLab02SerializationBehavior.serializerTypes.AsReadOnly();
			}
		}
		...
		public override global::System.Collections.ObjectModel.ReadOnlyCollection<DslModeling::DomainXmlSerializerNamespaceEntry> AllNamespaces
		{
			get
			{
				if (FeatureModelLab02SerializationBehavior.namespaceEntries == null)
				{
					FeatureModelLab02SerializationBehavior.namespaceEntries = new global::System.Collections.Generic.List<DslModeling::DomainXmlSerializerNamespaceEntry>();
					FeatureModelLab02SerializationBehavior.namespaceEntries.Add(new DslModeling::DomainXmlSerializerNamespaceEntry(DomainModelXmlNamespace, typeof(global::Company.FeatureModelLab02.FeatureModelLab02DomainModel)));
				}
				return FeatureModelLab02SerializationBehavior.namespaceEntries.AsReadOnly();
			}
		}
	...
	/// </summary>
	public sealed partial class FeatureModelLab02SerializationBehavior : FeatureModelLab02SerializationBehaviorBase
	{
		#region Singleton Instance
		/// <summary>
		/// Singleton instance.
		/// </summary>
		private static FeatureModelLab02SerializationBehavior instance;
	
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable (global::System.Diagnostics.DebuggerBrowsableState.Never)]	// Will trigger creation otherwise.
		public static FeatureModelLab02SerializationBehavior Instance
		{
			get
			{	// No need for synchronization. Most likely running in single-thread environment, and creating an extra instance
				// doesn't really hurt.
				if (FeatureModelLab02SerializationBehavior.instance == null)
					FeatureModelLab02SerializationBehavior.instance = new FeatureModelLab02SerializationBehavior ();
				return FeatureModelLab02SerializationBehavior.instance;
			}
		}
		...
		/// </summary>
		private FeatureModelLab02SerializationBehavior() : base() { }
		#endregion
	}
}
...
{
	/// <summary>
	/// Moniker resolver for serialization behavior FeatureModelLab02SerializationBehavior.
	/// </summary>
	public partial class FeatureModelLab02SerializationBehaviorMonikerResolver : FeatureModelLab02SerializationBehaviorMonikerResolverBase
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		public FeatureModelLab02SerializationBehaviorMonikerResolver(DslModeling::Store store, DslModeling::DomainXmlSerializerDirectory directory)
	...
	/// <summary>
	/// Base moniker resolver for serialization behavior FeatureModelLab02SerializationBehavior.
	/// </summary>
	public partial class FeatureModelLab02SerializationBehaviorMonikerResolverBase : DslModeling::SimpleMonikerResolver
	{
		#region Member Variables
		/// <summary>
		...
		/// <param name="store">Store for this moniker resolver.</param>
		/// <param name="directory">Directory to used by this resolver to look up for serializers.</param>
		public FeatureModelLab02SerializationBehaviorMonikerResolverBase(DslModeling::Store store, DslModeling::DomainXmlSerializerDirectory directory)
			: base (store)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(directory != null);
		...
		protected override void OnUnresolvedMoniker(DslModeling::SerializationResult serializationResult, DslModeling::Moniker moniker)
		{
			...
			{
				FeatureModelLab02SerializationBehaviorSerializationMessages.UnresolvedMoniker(serializationResult, moniker);
			}
		}
		...
		protected override void OnMonikerResolvedToDuplicateLink(DslModeling::SerializationResult serializationResult, DslModeling::Moniker moniker)
		{
			if (serializationResult != null)
			{
				FeatureModelLab02SerializationBehaviorSerializationMessages.MonikerResolvedToDuplicateLink(serializationResult, moniker);
			}
		...
		protected override void OnAmbiguousMoniker(DslModeling::SerializationContext context, string moniker, DslModeling::ModelElement element1, DslModeling::ModelElement element2)
		{
			if (context != null)
			{
				FeatureModelLab02SerializationBehaviorSerializationMessages.AmbiguousMoniker(context, moniker, element1, element2);
			}
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return FeatureModelLab02SerializationBehaviorSerializationMessages.ResourceManager.GetString("CannotOpenDocument"); }
		}
		#endregion
	}
}
...
namespace Company.FeatureModelLab02
{
	...
	/// </summary>
	public static partial class FeatureModelLab02SerializationBehaviorSerializationMessages
	{
		/// <summary>
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return FeatureModelLab02DomainModel.SingletonResourceManager; }
		}
...
namespace Company.FeatureModelLab02
{
	...
	/// that can be used to serialize / deserialize the FeatureModelLab02 domain model.
	/// </summary>
	/// <remarks>Double-derived class - the default implementation is in FeatureModelLab02DomainModelSerializerBase.
	...
	[DslModeling::DomainModelSerializer(typeof(global::Company.FeatureModelLab02.FeatureModelLab02DomainModel), global::Company.FeatureModelLab02.FeatureModelLab02SerializationBehavior.DomainModelXmlNamespace, "FeatureModelLab02")]
	public partial class FeatureModelLab02DomainModelSerializer : FeatureModelLab02DomainModelSerializerBase
	{
	}
	...
	/// </summary>
	public abstract partial class FeatureModelLab02DomainModelSerializerBase : DslModeling::IDomainModelSerializer
	{
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return global::Company.FeatureModelLab02.FeatureModelLab02SerializationBehavior.DomainModelXmlNamespace; }
		}
		...
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get { return typeof(global::Company.FeatureModelLab02.FeatureModelLab02DomainModel); }
		}
			...
			DslModeling::ISerializerLocator serializerLocator)
		{
			...
			return FeatureModelLab02SerializationHelper.Instance.LoadModel(serializationResult, partition, fileName, null, null, serializerLocator);
		}
			...
			System.Text.Encoding encoding)
		{
			...
			global::Company.FeatureModelLab02.FeatureModel rootElement = modelRoot as global::Company.FeatureModelLab02.FeatureModel;
			if (rootElement == null)
			{
				string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
					global::Company.FeatureModelLab02.FeatureModelLab02DomainModel.SingletonResourceManager.GetString("InvalidSaveRootElementType"),
			...
			FeatureModelLab02SerializationHelper.Instance.SaveModel(serializationResult, rootElement, fileName,encoding, true);
		}
			...
			DslModeling::ISerializerLocator serializerLocator)
		{
			...
			return FeatureModelLab02SerializationHelper.Instance.LoadModelAndDiagram(serializationResult, modelPartition, modelFileName, diagramPartition, diagramFileName, null, null, serializerLocator);
		}
			...
			System.Text.Encoding encoding)
		{
			...
			global::Company.FeatureModelLab02.FeatureModel typedRoot = modelRoot as global::Company.FeatureModelLab02.FeatureModel;
			if (typedRoot == null)
			{
				string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
					global::Company.FeatureModelLab02.FeatureModelLab02DomainModel.SingletonResourceManager.GetString("InvalidSaveRootElementType"),
			...
			global::Company.FeatureModelLab02.FeatureModelLab02Diagram typedDiagram = diagram as global::Company.FeatureModelLab02.FeatureModelLab02Diagram;
			if (typedDiagram == null)
			{
				string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
					global::Company.FeatureModelLab02.FeatureModelLab02DomainModel.SingletonResourceManager.GetString("InvalidSaveDiagramType"),
					diagram.GetType().ToString());
	
				throw new global::System.ArgumentException(errorMessage, "diagram");
			}
	
			FeatureModelLab02SerializationHelper.Instance.SaveModelAndDiagram(serializationResult, typedRoot, modelFileName, typedDiagram, diagramFileName, encoding, true);
		}
