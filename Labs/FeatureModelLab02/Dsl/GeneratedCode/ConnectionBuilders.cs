...
namespace Company.FeatureModelLab02
{
	...
	public static partial class FeatureElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.FeatureModelLab02.FeatureElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.FeatureModelLab02.FeatureElement)
				{
					if (candidateTarget is global::Company.FeatureModelLab02.FeatureElement)
					{
						global::Company.FeatureModelLab02.FeatureElement sourceFeatureElement = (global::Company.FeatureModelLab02.FeatureElement)candidateSource;
						global::Company.FeatureModelLab02.FeatureElement targetFeatureElement = (global::Company.FeatureModelLab02.FeatureElement)candidateTarget;
						if(targetFeatureElement == null || sourceFeatureElement == null || global::Company.FeatureModelLab02.FeatureElementReferencesTargets.GetLinks(sourceFeatureElement, targetFeatureElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.FeatureModelLab02.FeatureElement)
				{
					if (target is global::Company.FeatureModelLab02.FeatureElement)
					{
						global::Company.FeatureModelLab02.FeatureElement sourceAccepted = (global::Company.FeatureModelLab02.FeatureElement)source;
						global::Company.FeatureModelLab02.FeatureElement targetAccepted = (global::Company.FeatureModelLab02.FeatureElement)target;
						DslModeling::ElementLink result = new global::Company.FeatureModelLab02.FeatureElementReferencesTargets(sourceAccepted, targetAccepted);
