...
namespace Company.FeatureModelLab02
{
	...
	/// </summary>
	internal partial class FeatureModelLab02DocView : FeatureModelLab02DocViewBase
	{
		/// <summary>
		/// Constructs a new FeatureModelLab02DocView.
		/// </summary>
		public FeatureModelLab02DocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class FeatureModelLab02DocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new FeatureModelLab02DocView.
		/// </summary>
		protected FeatureModelLab02DocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			FeatureModelLab02DocDataBase docData = this.DocData as FeatureModelLab02DocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for FeatureModelLab02DocViewBase should be an FeatureModelLab02DocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.FeatureModelLab02.FeatureModelLab02Diagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.FeatureModelLab02.FeatureModelLab02Diagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.FeatureModelLab02.FeatureModelLab02ToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.FeatureModelLab02.FeatureModelLab02ToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.FeatureModelLab02DiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.FeatureModelLab02.FeatureModelLab02HelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.FeatureModelLab02.FeatureModelLab02HelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.FeatureModelLab02.FeatureModelLab02HelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
