...
namespace Company.FeatureModelLab02
{
	...
	/// </summary>
	internal partial class FeatureModelLab02DocData : FeatureModelLab02DocDataBase
	{
		/// <summary>
		/// Constructs a new FeatureModelLab02DocData.
		/// </summary>
		public FeatureModelLab02DocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a FeatureModelLab02 document in memory.
	/// </summary>
	internal abstract partial class FeatureModelLab02DocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new FeatureModelLab02DocDataBase.
		/// </summary>
		protected FeatureModelLab02DocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Company.FeatureModelLab02.FeatureModelLab02DomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Company.FeatureModelLab02.FeatureModelLab02DomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Company.FeatureModelLab02.FeatureModelLab02DomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Company.FeatureModelLab02.FeatureModelLab02DomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Company.FeatureModelLab02.FeatureModel modelRoot = null;
			...
			global::Company.FeatureModelLab02.FeatureModelLab02DomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Company.FeatureModelLab02.FeatureModelLab02SerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Company.FeatureModelLab02.FeatureModelLab02DomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Company.FeatureModelLab02.FeatureModelLab02DomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Company.FeatureModelLab02.FeatureModel modelRoot = (global::Company.FeatureModelLab02.FeatureModel)this.RootElement;
			...
			{
				global::Company.FeatureModelLab02.FeatureModelLab02Diagram diagram = diagrams[0] as global::Company.FeatureModelLab02.FeatureModelLab02Diagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Company.FeatureModelLab02.FeatureModelLab02SerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Company.FeatureModelLab02.FeatureModelLab02SerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Company.FeatureModelLab02.FeatureModelLab02DomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Company.FeatureModelLab02.FeatureModelLab02SerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Company.FeatureModelLab02.FeatureModel modelRoot = this.RootElement as global::Company.FeatureModelLab02.FeatureModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Company.FeatureModelLab02.FeatureModelLab02SerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
