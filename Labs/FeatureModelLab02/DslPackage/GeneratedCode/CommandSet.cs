...
namespace Company.FeatureModelLab02
{
	...
	/// </summary>
	internal partial class FeatureModelLab02CommandSet : FeatureModelLab02CommandSetBase
	{
		/// <summary>
		/// Constructs a new FeatureModelLab02CommandSet.
		/// </summary>
		public FeatureModelLab02CommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class FeatureModelLab02CommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new FeatureModelLab02CommandSetBase.
		/// </summary>
		protected FeatureModelLab02CommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewFeatureModelLab02ExplorerCommand,
				typeof(FeatureModelLab02EditorFactory).GUID);
		...
		{
			FeatureModelLab02ExplorerToolWindow explorer = this.FeatureModelLab02ExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected FeatureModelLab02DocData CurrentFeatureModelLab02DocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as FeatureModelLab02DocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected FeatureModelLab02DocView CurrentFeatureModelLab02DocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as FeatureModelLab02DocView;
			}
		}
		...
		/// </summary>
		protected FeatureModelLab02ExplorerToolWindow FeatureModelLab02ExplorerToolWindow
		{
			get
			{
				FeatureModelLab02ExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(FeatureModelLab02ExplorerToolWindow), true) as FeatureModelLab02ExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				FeatureModelLab02ExplorerToolWindow explorerWindow = this.FeatureModelLab02ExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class FeatureModelLab02ClipboardCommandSet : FeatureModelLab02ClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new FeatureModelLab02ClipboardCommandSet.
		/// </summary>
		public FeatureModelLab02ClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class FeatureModelLab02ClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new FeatureModelLab02ClipboardCommandSetBase.
		/// </summary>
		protected FeatureModelLab02ClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
