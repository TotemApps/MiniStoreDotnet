...
namespace Company.FeatureSpl
{
	...
	/// </summary>
	internal partial class FeatureSplCommandSet : FeatureSplCommandSetBase
	{
		/// <summary>
		/// Constructs a new FeatureSplCommandSet.
		/// </summary>
		public FeatureSplCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class FeatureSplCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new FeatureSplCommandSetBase.
		/// </summary>
		protected FeatureSplCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewFeatureSplExplorerCommand,
				typeof(FeatureSplEditorFactory).GUID);
		...
		{
			FeatureSplExplorerToolWindow explorer = this.FeatureSplExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected FeatureSplDocData CurrentFeatureSplDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as FeatureSplDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected FeatureSplDocView CurrentFeatureSplDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as FeatureSplDocView;
			}
		}
		...
		/// </summary>
		protected FeatureSplExplorerToolWindow FeatureSplExplorerToolWindow
		{
			get
			{
				FeatureSplExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(FeatureSplExplorerToolWindow), true) as FeatureSplExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				FeatureSplExplorerToolWindow explorerWindow = this.FeatureSplExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class FeatureSplClipboardCommandSet : FeatureSplClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new FeatureSplClipboardCommandSet.
		/// </summary>
		public FeatureSplClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class FeatureSplClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new FeatureSplClipboardCommandSetBase.
		/// </summary>
		protected FeatureSplClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
