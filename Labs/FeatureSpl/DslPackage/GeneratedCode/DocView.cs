...
namespace Company.FeatureSpl
{
	...
	/// </summary>
	internal partial class FeatureSplDocView : FeatureSplDocViewBase
	{
		/// <summary>
		/// Constructs a new FeatureSplDocView.
		/// </summary>
		public FeatureSplDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class FeatureSplDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new FeatureSplDocView.
		/// </summary>
		protected FeatureSplDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			FeatureSplDocDataBase docData = this.DocData as FeatureSplDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for FeatureSplDocViewBase should be an FeatureSplDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.FeatureSpl.FeatureSplDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.FeatureSpl.FeatureSplDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.FeatureSpl.FeatureSplToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.FeatureSpl.FeatureSplToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.FeatureSplDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.FeatureSpl.FeatureSplHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.FeatureSpl.FeatureSplHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.FeatureSpl.FeatureSplHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
