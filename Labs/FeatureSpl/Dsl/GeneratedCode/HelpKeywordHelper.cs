...
namespace Company.FeatureSpl
{
	...
	/// </remarks>
	public partial class FeatureSplHelpKeywordHelper : FeatureSplHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new FeatureSplHelpKeywordHelper.
		/// </summary>
		protected FeatureSplHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the FeatureSplHelpKeywordHelper.
		/// </summary>
		public static FeatureSplHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class FeatureSplHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new FeatureSplHelpKeywordHelperBase.
		/// </summary>
		protected FeatureSplHelpKeywordHelperBase()
			: base() { }
