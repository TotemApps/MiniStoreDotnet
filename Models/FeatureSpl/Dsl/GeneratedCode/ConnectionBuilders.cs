...
namespace Company.FeatureSpl
{
	...
	public static partial class FeatureElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.FeatureSpl.FeatureElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.FeatureSpl.FeatureElement)
				{
					if (candidateTarget is global::Company.FeatureSpl.FeatureElement)
					{
						global::Company.FeatureSpl.FeatureElement sourceFeatureElement = (global::Company.FeatureSpl.FeatureElement)candidateSource;
						global::Company.FeatureSpl.FeatureElement targetFeatureElement = (global::Company.FeatureSpl.FeatureElement)candidateTarget;
						if(targetFeatureElement == null || sourceFeatureElement == null || global::Company.FeatureSpl.FeatureElementReferencesTargets.GetLinks(sourceFeatureElement, targetFeatureElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.FeatureSpl.FeatureElement)
				{
					if (target is global::Company.FeatureSpl.FeatureElement)
					{
						global::Company.FeatureSpl.FeatureElement sourceAccepted = (global::Company.FeatureSpl.FeatureElement)source;
						global::Company.FeatureSpl.FeatureElement targetAccepted = (global::Company.FeatureSpl.FeatureElement)target;
						DslModeling::ElementLink result = new global::Company.FeatureSpl.FeatureElementReferencesTargets(sourceAccepted, targetAccepted);
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class RootFeatureElementReferencesFeatureElementsBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::Company.FeatureSpl.RootFeatureElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.FeatureSpl.RootFeatureElement)
				{
					if (candidateTarget is global::Company.FeatureSpl.FeatureElement)
					{
						global::Company.FeatureSpl.RootFeatureElement sourceRootFeatureElement = (global::Company.FeatureSpl.RootFeatureElement)candidateSource;
						global::Company.FeatureSpl.FeatureElement targetFeatureElement = (global::Company.FeatureSpl.FeatureElement)candidateTarget;
						if(targetFeatureElement == null || sourceRootFeatureElement == null || global::Company.FeatureSpl.RootFeatureElementReferencesFeatureElements.GetLinks(sourceRootFeatureElement, targetFeatureElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Company.FeatureSpl.RootFeatureElement)
				{
					if (target is global::Company.FeatureSpl.FeatureElement)
					{
						global::Company.FeatureSpl.RootFeatureElement sourceAccepted = (global::Company.FeatureSpl.RootFeatureElement)source;
						global::Company.FeatureSpl.FeatureElement targetAccepted = (global::Company.FeatureSpl.FeatureElement)target;
						DslModeling::ElementLink result = new global::Company.FeatureSpl.RootFeatureElementReferencesFeatureElements(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	internal partial class MandatoryRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		...
		private partial class MandatoryRelationshipConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder RootFeatureElementReferencesFeatureElementsBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				bool canConnect = true;
				...
				{				
					if(targetShapeElement == null)
					{
						return RootFeatureElementReferencesFeatureElementsBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return RootFeatureElementReferencesFeatureElementsBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				DslModeling::ModelElement targetElement = targetShapeElement.ModelElement;
				if(targetElement == null) targetElement = targetShapeElement;
				RootFeatureElementReferencesFeatureElementsBuilder.Connect(sourceElement, targetElement);
			}
		}
