...
namespace Company.SplLanguage
{
	...
	[VSShell::ProvideToolWindow(typeof(SplLanguageExplorerToolWindow), MultiInstances = false, Style = VSShell::VsDockStyle.Tabbed, Orientation = VSShell::ToolWindowOrientation.Right, Window = "{3AE79031-E1BC-11D0-8F78-00A0C9110057}")]
	[VSShell::ProvideToolWindowVisibility(typeof(SplLanguageExplorerToolWindow), Constants.SplLanguageEditorFactoryId)]
	[VSShell::ProvideStaticToolboxGroup("@SplLanguageToolboxTab;Company.SplLanguage.Dsl.dll", "Company.SplLanguage.SplLanguageToolboxTab")]
	[VSShell::ProvideStaticToolboxItem("Company.SplLanguage.SplLanguageToolboxTab",
					"@FeatureElementToolboxItem;Company.SplLanguage.Dsl.dll", 
					"Company.SplLanguage.FeatureElementToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"CreateExampleClassF1Keyword", 
					"@FeatureElementToolboxBitmap;Company.SplLanguage.Dsl.dll", 
					0xff00ff,
					Index = 0)]
	[VSShell::ProvideStaticToolboxItem("Company.SplLanguage.SplLanguageToolboxTab",
					"@OptionalRelationshipToolboxItem;Company.SplLanguage.Dsl.dll", 
					"Company.SplLanguage.OptionalRelationshipToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"ConnectExampleRelationF1Keyword", 
					"@OptionalRelationshipToolboxBitmap;Company.SplLanguage.Dsl.dll", 
					0xff00ff,
					Index = 1)]
	[VSShell::ProvideStaticToolboxItem("Company.SplLanguage.SplLanguageToolboxTab",
					"@MandatoryRelationshipToolboxItem;Company.SplLanguage.Dsl.dll", 
					"Company.SplLanguage.MandatoryRelationshipToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"MandatoryRelationship", 
					"@MandatoryRelationshipToolboxBitmap;Company.SplLanguage.Dsl.dll", 
					0xff00ff,
					Index = 2)]
	[VSShell::ProvideStaticToolboxItem("Company.SplLanguage.SplLanguageToolboxTab",
					"@RequiresRelationshipToolboxItem;Company.SplLanguage.Dsl.dll", 
					"Company.SplLanguage.RequiresRelationshipToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"RequiresRelationship", 
					"@RequiresRelationshipToolboxBitmap;Company.SplLanguage.Dsl.dll", 
					0xff00ff,
					Index = 3)]
	[VSShell::ProvideStaticToolboxItem("Company.SplLanguage.SplLanguageToolboxTab",
					"@ExcludeRelationshipToolboxItem;Company.SplLanguage.Dsl.dll", 
					"Company.SplLanguage.ExcludeRelationshipToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"ExcludeRelationship", 
	...
	[DslShell::ProvideXmlEditorChooserBlockSxSWithXmlEditor(@"SplLanguage", typeof(SplLanguageEditorFactory))]

	internal abstract partial class SplLanguagePackageBase : DslShell::AsyncModelingPackage
	{
		protected global::Company.SplLanguage.SplLanguageToolboxHelper toolboxHelper;	
		...
		protected async override Task InitializeAsync(CancellationToken cancellationToken, IProgress<VSShell.ServiceProgressData> progress)
		{
			...
			this.RegisterEditorFactory(new SplLanguageEditorFactory(this));
			
			// Initialize the toolbox helper
			toolboxHelper = new global::Company.SplLanguage.SplLanguageToolboxHelper(this);

			// Create the command set that handles menu commands provided by this package.
			SplLanguageCommandSet commandSet = new SplLanguageCommandSet(this);
			...
			SplLanguageClipboardCommandSet clipboardCommandSet = new SplLanguageClipboardCommandSet(this);
			await clipboardCommandSet.InitializeAsync(cancellationToken);
			
			// Register the model explorer tool window for this DSL.
			this.AddToolWindow(typeof(SplLanguageExplorerToolWindow));
		...
		{
			if (toolWindowType == typeof(SplLanguageExplorerToolWindow).GUID)
			{
				return this;
			}
...
namespace Company.SplLanguage
{
	...
	internal sealed partial class SplLanguagePackage : SplLanguagePackageBase
	{
	}
}