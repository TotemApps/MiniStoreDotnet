...
namespace Company.SplLanguage
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.SplLanguageEditorFactoryId)]
	internal partial class SplLanguageEditorFactory : SplLanguageEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new SplLanguageEditorFactory.
		/// </summary>
		public SplLanguageEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class SplLanguageEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected SplLanguageEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new SplLanguageDocData(this.ServiceProvider, typeof(SplLanguageEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new SplLanguageDocView(docData, this.ServiceProvider);
		}
	}
}
