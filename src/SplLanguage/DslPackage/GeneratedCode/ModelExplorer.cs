...
namespace Company.SplLanguage
{
	...
	/// </summary>
	internal partial class SplLanguageExplorer : SplLanguageExplorerBase
	{
		/// <summary>
		/// Constructs a new SplLanguageExplorer.
		/// </summary>
		public SplLanguageExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the SplLanguageExplorerToolWindow.
	/// </summary>
	internal abstract class SplLanguageExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new SplLanguageExplorerBase.
		/// </summary>
		protected SplLanguageExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.SplLanguageExplorerMenu;
			}
		}
		...
		{
			get { return global::Company.SplLanguage.FeatureModel.DomainClassId; }
		}
