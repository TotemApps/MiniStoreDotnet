...
namespace Company.SplLanguage
{
	...
	/// </summary>
	internal partial class SplLanguageDocView : SplLanguageDocViewBase
	{
		/// <summary>
		/// Constructs a new SplLanguageDocView.
		/// </summary>
		public SplLanguageDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class SplLanguageDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new SplLanguageDocView.
		/// </summary>
		protected SplLanguageDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			SplLanguageDocDataBase docData = this.DocData as SplLanguageDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for SplLanguageDocViewBase should be an SplLanguageDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.SplLanguage.SplLanguageDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.SplLanguage.SplLanguageDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.SplLanguage.SplLanguageToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.SplLanguage.SplLanguageToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.SplLanguageDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.SplLanguage.SplLanguageHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.SplLanguage.SplLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.SplLanguage.SplLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
