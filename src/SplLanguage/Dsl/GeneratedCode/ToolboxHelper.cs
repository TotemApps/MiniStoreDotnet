...
namespace Company.SplLanguage
{
	...
	/// </remarks>
	public partial class SplLanguageToolboxHelper : SplLanguageToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new SplLanguageToolboxHelper.
		/// </summary>
		public SplLanguageToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class SplLanguageToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify SplLanguage toolbox items.  
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Constructs a new SplLanguageToolboxHelperBase.
		/// </summary>
		protected SplLanguageToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.SplLanguage.SplLanguageDomainModel.SingletonResourceManager.GetString("SplLanguageToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.SplLanguage.SplLanguageDomainModel.SingletonResourceManager;
			...
			switch(itemId)
			{
				...
				case "Company.SplLanguage.MandatoryRelationshipToolboxItem":
					...
					break;
				case "Company.SplLanguage.RequiresRelationshipToolboxItem":

					// Add RequiresRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.SplLanguage.RequiresRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						4, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("RequiresRelationshipToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("RequiresRelationshipToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"Company.SplLanguage.SplLanguageToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("SplLanguageToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"RequiresRelationship", // F1 help keyword for the toolbox item.
						resourceManager.GetString("RequiresRelationshipToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.SplLanguage.SplLanguageDomainModel));
