...
namespace Company.SplLanguage
{
	...
	/// </remarks>
	public partial class SplLanguageHelpKeywordHelper : SplLanguageHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new SplLanguageHelpKeywordHelper.
		/// </summary>
		protected SplLanguageHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the SplLanguageHelpKeywordHelper.
		/// </summary>
		public static SplLanguageHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class SplLanguageHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new SplLanguageHelpKeywordHelperBase.
		/// </summary>
		protected SplLanguageHelpKeywordHelperBase()
			: base() { }
